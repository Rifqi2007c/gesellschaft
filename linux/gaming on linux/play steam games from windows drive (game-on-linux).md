- ￼￼gaming on linux￼￼![[gaming on linux|no-title]]### configuring and mounting the NTFS partition
- ##### required package dependecies
	- `ntfs-3g`
...
- ##### editing fstab to add windows drive
	- fstab located at `/etc/fstab`
		...
		- example
```
> UUID=38CE9483CE943AD8 /media/gamedisk ntfs defaults,uid=1000,gid=1000,nofail 0 0
```
- ##### reboot
	- `sudo reboot`

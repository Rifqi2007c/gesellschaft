...
### make ssh key (for passwordless push or private repo clone)
- install `openssh`
...
### transfer key to new device or operating system
- generate key: `ssh-keygen -t ed25519 -C "<your@emal.com>"`
- delete the new generated key and add old one (or overwirte while copy paste)
- verify key: `ssh -T git@github.com`
- update url to ssh link if previously clone git repo with HTTP link
	- `git remote set-url <brance> <ssh-url>`
